...
v0.7.1은 v0.7.0의 변화 중심 첫 화면을 유지하면서 장기금리 해석을 30년짜리 금리끼리 나눠 보는 방식으로 정리합니다. 기업 신용 범위·지속 엔진, 핵심 6개 상태 규칙, aux direction schema, decision snapshot schema는 바꾸지 않습니다.
...
- 10년 실질금리와 10년 명목−실질 금리차는 다른 만기의 참고 신호
- 10년 장기채 추가 보상은 30년 두 부분으로 나눈 값에 더하지 않는 참고용
...
- 두 금리의 차이 계산 1회, UI·Telegram·저장 동일 결과
