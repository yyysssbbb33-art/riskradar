...
_BRANCHES: dict[str, tuple[str, str, str]] = {
    "BREAKEVEN": (
        "오르면 10년 명목−실질 금리차가 커지는 방향입니다. 30년 금리 구성은 같은 만기의 전용 패널을 우선하고, 여기서는 10년 구간의 교차 만기 맥락만 참고합니다.",
        "내리면 10년 명목−실질 금리차가 줄어드는 방향입니다. 다른 만기의 금리 변화를 직접 설명한다고 단정하지 않습니다.",
        "뚜렷한 움직임이 없으면 10년 구간의 명목−실질 금리차에서 강한 추가 변화는 확인되지 않습니다.",
    ),
    "TERMPREM": (
        "오르면 10년 장기채를 오래 보유하기 위해 요구하는 추가 보상이 커지는 방향입니다. 30년 동일 만기 산술 구성과는 별도 맥락으로 봅니다.",
        "내리면 10년 장기채 추가 보상이 줄어드는 방향입니다. 30년 금리와 방향이 같거나 달라도 직접 원인으로 단정하지 않습니다.",
        "뚜렷한 움직임이 없으면 10년 Term Premium에서 강한 추가 변화는 확인되지 않습니다.",
    ),
    "BBBOAS": (
