...
RATES_30UP_2DOWN = Combo(
    ...
    [
        ("real", "10년 실질금리도 같은 방향인지 보는 교차 만기 맥락"),
        ("infl", "10년 명목−실질 금리차도 같은 방향인지 보는 교차 만기 맥락"),
        ("tp", "10년 Term Premium도 같은 방향인지 보는 별도 맥락"),
        ("cut", "2년물 하락이 정책완화 기대·경기둔화 우려를 반영한다는 설명"),
    ],
    [
        Check("DFII10", "10년 실질금리",
              "10년 실질금리도 상승합니다. 30년물과 같은 방향의 교차 만기 맥락입니다.",
              "10년 실질금리는 하락합니다. 30년물과 방향이 엇갈리는 교차 만기 맥락입니다.",
              "10년 실질금리에 뚜렷한 변화가 없습니다. 30년 구성의 직접 요소로 해석하지 않습니다.",
              supports_up=("real",), weakens_down=("real",)),
        Check("BREAKEVEN", "10년 명목−실질 금리차",
              "10년 명목−실질 금리차도 상승합니다. 30년물과 같은 방향의 교차 만기 맥락입니다.",
              "10년 명목−실질 금리차는 하락합니다. 30년물과 방향이 엇갈리는 교차 만기 맥락입니다.",
              "10년 명목−실질 금리차에 뚜렷한 변화가 없습니다. 30년 구성은 동일 만기 패널을 우선 봅니다.",
              supports_up=("infl",), weakens_down=("infl",), weakens_flat=("infl",)),
        Check("TERMPREM", "10년 Term Premium",
              "10년 Term Premium도 상승합니다. 30년 구성요소는 아니며 별도 맥락이 같은 방향입니다.",
              "10년 Term Premium은 하락합니다. 30년물과 방향이 엇갈리는 별도 맥락입니다.",
              "10년 Term Premium에 뚜렷한 변화가 없습니다. 30년 동일 만기 구성과 분리해서 봅니다.",
    ...
    "10년 지표는 30년 금리의 산술 구성요소가 아닙니다. 다른 만기에서 같은 방향인지 보는 참고 맥락으로만 사용합니다.",
)
...
RATES_30DOWN_2UP = Combo(
    ...
    [
        ...
        ("infl", "10년 명목−실질 금리차도 하락하는 교차 만기 맥락"),
    ],
    [
        Check("BREAKEVEN", "10년 명목−실질 금리차",
              "10년 명목−실질 금리차는 상승합니다. 30년물과 방향이 엇갈리는 교차 만기 맥락입니다.",
              "10년 명목−실질 금리차도 하락합니다. 30년물과 같은 방향의 교차 만기 맥락입니다.",
              "10년 명목−실질 금리차에 뚜렷한 변화가 없습니다. 30년 구성은 동일 만기 패널을 우선 봅니다.",
...
RATES_BROAD_UP = Combo(
    ...
    [
        ...
        ("infl", "10년 명목−실질 금리차도 상승하는 교차 만기 맥락"),
        ("policy", "가까운 정책금리 경로가 더 높아졌다는 설명"),
    ],
    [
        Check("BREAKEVEN", "10년 명목−실질 금리차",
              "10년 명목−실질 금리차도 상승합니다. 금리 전반과 같은 방향의 교차 만기 맥락입니다.",
              "10년 명목−실질 금리차는 하락합니다. 금리 전반과 방향이 엇갈리는 교차 만기 맥락입니다.",
              "10년 명목−실질 금리차는 보합입니다. 30년 구성의 직접 요소로 해석하지 않습니다.",
...
RATES_BROAD_DOWN = Combo(
    ...
    [
        ...
        Check("BREAKEVEN", "10년 명목−실질 금리차",
              "10년 명목−실질 금리차는 상승합니다. 단순한 물가보상 둔화와는 방향이 엇갈립니다.",
              "10년 명목−실질 금리차도 하락합니다. 10년 구간에서도 물가보상이 낮아지는 방향입니다.",
              "10년 명목−실질 금리차는 보합입니다. 이 지표만으로 금리 하락 이유를 정하지 않습니다.",
...
TWO_DOWN_CREDIT_WIDENING = Combo(
    ...
    [
        Check("BBBOAS", "투자등급 경계 기업의 추가 금리",
              ...
              "투자등급 경계 기업의 추가 금리는 줄어듭니다. 부담 확대가 더 넓게 이어진다는 설명은 약해집니다.",
...
TWO_DOWN_CREDIT_QUIET = Combo(
    ...
    [
        Check("BREAKEVEN", "10년 명목−실질 금리차",
              "10년 명목−실질 금리차는 상승합니다. 단순한 물가보상 둔화와는 방향이 엇갈립니다.",
              "10년 명목−실질 금리차도 하락합니다. 10년 구간에서도 물가보상이 낮아지는 방향입니다.",
              "10년 명목−실질 금리차는 보합입니다. 이 지표만으로 2년물 하락 이유를 정하지 않습니다.",
              supports_down=("easing",), weakens_up=("easing",)),
    ],
...
VOL_CREDIT_TOGETHER = Combo(
    ...
    [
        Check("BBBOAS", "투자등급 경계 기업의 추가 금리",
              ...
              "투자등급 경계 기업의 추가 금리는 줄어듭니다. 회사채 부담 확대가 저신용 기업에 더 집중됐을 수 있습니다.",
