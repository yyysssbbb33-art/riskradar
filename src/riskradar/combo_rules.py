...
RATES_30UP_2DOWN = Combo(
    ...
    [
        ...
        Check("AOAS", "A등급 기업의 추가금리",
              "A등급 기업의 추가금리도 확대됩니다. 2년물 하락을 경기둔화·금융여건 우려와 함께 읽을 근거가 늘어납니다.",
              "A등급 기업의 추가금리는 축소됩니다. 광범위한 신용 스트레스 설명은 약해집니다.",
              "A등급 기업의 추가금리에 뚜렷한 변화가 없습니다. 광범위한 신용 변화 근거는 약합니다.",
...
RATES_BROAD_UP = Combo(
    ...
    [
        ...
        Check("AOAS", "A등급 기업의 추가금리",
              "A등급 기업의 추가금리도 확대됩니다. 금리 상승과 신용시장 변화가 같은 시기에 나타납니다.",
              "A등급 기업의 추가금리는 축소됩니다. 광범위한 신용 스트레스 설명은 약합니다.",
              "A등급 기업의 추가금리는 기본입니다. 현재는 신용 변화보다 금리 재평가 쪽을 더 확인합니다."),
    ],
...
RATES_BROAD_DOWN = Combo(
    ...
    [
        Check("AOAS", "A등급 기업의 추가금리",
              "A등급 기업의 추가금리가 확대됩니다. 경기둔화·금융여건 우려 설명을 더 지지합니다.",
              "A등급 기업의 추가금리는 축소됩니다. 광범위한 신용 스트레스 설명은 약해집니다.",
              "A등급 기업의 추가금리는 기본입니다. 정책완화·물가둔화 설명과 상대적으로 더 잘 맞을 수 있습니다.",
...
TWO_DOWN_CREDIT_WIDENING = Combo(
    ...
    [
        Check("BBBOAS", "투자등급 경계 기업의 추가금리",
              "투자등급 경계 기업의 추가금리도 확대됩니다. 기업 부담이 저신용 구간을 넘어 번지는 설명을 더 지지합니다.",
              "투자등급 경계 기업의 추가금리는 줄어듭니다. 부담 확대가 더 넓게 번진다는 설명은 약해집니다.",
              "투자등급 경계 기업에는 뚜렷한 변화가 없습니다. 현재는 저신용 기업 중심 변화일 수 있습니다.",
              supports_up=("slow",), weakens_down=("slow",)),
        Check("AOAS", "A등급 기업의 추가금리",
              "A등급 기업의 추가금리도 확대됩니다. 신용 변화의 범위가 넓다는 설명을 더 지지합니다.",
              "A등급 기업의 추가금리는 축소됩니다. 광범위한 신용 변화 설명은 약합니다.",
              "A등급 기업의 추가금리는 보합입니다. 하이일드 중심 변화일 가능성을 확인합니다.",
              supports_up=("slow",), weakens_down=("slow",)),
        Check("CPSPREAD", "기업 신용도에 따른 단기자금 금리 차이",
              "단기자금 금리 차이도 벌어집니다. 회사채뿐 아니라 단기 자금조달에서도 신용도에 따른 부담 차이가 커진다는 설명을 지지합니다.",
              "단기자금 금리 차이는 줄어듭니다. 단기 자금시장까지 부담이 번졌다는 설명은 약해집니다.",
              "단기자금 금리 차이에 뚜렷한 변화가 없습니다. 단기 자금시장까지 같은 변화가 번졌다는 근거는 아직 약합니다.",
...
TWO_DOWN_CREDIT_QUIET = Combo(
    ...
    "2년물은 하락하지만 HY OAS와 A등급 기업의 추가금리의 광범위한 확대는 뚜렷하지 않습니다.",
    [
...
VOL_LEADS = Combo(
    ...
    [
        Check("AOAS", "A등급 기업의 추가금리",
              "A등급 기업의 추가금리도 확대됩니다. 주식 변동성만의 변화라는 설명은 약해집니다.",
              "A등급 기업의 추가금리는 축소됩니다. 주식시장 중심 변화 설명과 더 잘 맞습니다.",
              "A등급 기업의 추가금리는 보합입니다. 광범위한 신용 변화 근거는 아직 약합니다.",
              supports_down=("event",), supports_flat=("event",), supports_up=("early",), weakens_up=("event",)),
        Check("CPSPREAD", "기업 신용도에 따른 단기자금 금리 차이",
              "단기자금 금리 차이도 벌어집니다. 주식시장만의 이벤트보다 자금시장으로 번지는 초기 설명을 더 확인합니다.",
              "단기자금 금리 차이는 줄어듭니다. 주식시장 중심 변화 설명과 더 잘 맞습니다.",
              "단기자금 금리 차이에 뚜렷한 변화가 없습니다. 현재로서는 단기 자금시장까지 번진 근거가 약합니다.",
...
CREDIT_ONLY = Combo(
    ...
    [
        Check("BBBOAS", "투자등급 경계 기업의 추가금리",
              "투자등급 경계 기업까지 추가금리가 확대됩니다. 저신용 기업에만 머무르지 않는 설명을 지지합니다.",
              "투자등급 경계 기업의 추가금리는 줄어듭니다. 저신용 기업에 집중된 설명과 더 잘 맞습니다.",
              "투자등급 경계 기업에는 뚜렷한 변화가 없습니다. 아직 저신용 기업 중심일 가능성이 큽니다.",
              supports_up=("broad",), supports_down=("idio",), supports_flat=("idio",)),
        Check("AOAS", "A등급 기업의 추가금리",
              "A등급 기업의 추가금리도 확대됩니다. 변화가 더 넓은 신용시장으로 이어지는 설명을 지지합니다.",
              "A등급 기업의 추가금리는 축소됩니다. 저신용 구간에 국한된 설명을 더 지지합니다.",
              "A등급 기업의 추가금리는 보합입니다. 아직 하이일드 중심 변화일 가능성을 확인합니다.",
              supports_up=("broad",), supports_down=("idio",), supports_flat=("idio",)),
        Check("CPSPREAD", "기업 신용도에 따른 단기자금 금리 차이",
              "단기자금 금리 차이도 벌어집니다. 회사채 변화와 함께 단기 자금조달 차별도 커지는 설명을 지지합니다.",
              "단기자금 금리 차이는 줄어듭니다. 현재 변화가 회사채 쪽에 더 집중된 설명과 맞습니다.",
              "단기자금 금리 차이에 뚜렷한 변화가 없습니다. 단기 자금시장까지 번진 근거는 약합니다.",
              supports_up=("broad",), supports_down=("idio",), supports_flat=("idio",)),
    ],
...
VOL_CREDIT_TOGETHER = Combo(
    ...
    [
        Check("BBBOAS", "투자등급 경계 기업의 추가금리",
              "투자등급 경계 기업까지 추가금리가 확대됩니다. 기업 부담이 더 넓게 번진다는 설명을 지지합니다.",
              "투자등급 경계 기업의 추가금리는 줄어듭니다. 회사채 부담 확대가 저신용 기업에 더 집중됐을 수 있습니다.",
              "투자등급 경계 기업에는 뚜렷한 변화가 없습니다. 확산 범위가 넓다는 근거는 아직 제한적입니다.",
              supports_up=("broad",), supports_down=("hy",), supports_flat=("hy",)),
        Check("AOAS", "A등급 기업의 추가금리",
              "A등급 기업의 추가금리도 확대됩니다. 신용 변화의 범위가 넓어진다는 설명을 더 지지합니다.",
              "A등급 기업의 추가금리는 축소됩니다. 신용 변화가 하이일드 중심이라는 설명과 더 잘 맞습니다.",
              "A등급 기업의 추가금리는 보합입니다. 투자등급 안쪽까지 넓어지는 근거는 아직 약합니다.",
              supports_up=("broad",), supports_down=("hy",), supports_flat=("hy",)),
        Check("CPSPREAD", "기업 신용도에 따른 단기자금 금리 차이",
              "단기자금 금리 차이도 벌어집니다. 주식과 회사채뿐 아니라 단기 자금시장에서도 부담 차이가 커지는 모습입니다.",
              "단기자금 금리 차이는 줄어듭니다. 단기 자금시장까지 같은 변화가 번졌다는 설명은 약해집니다.",
              "단기자금 금리 차이에 뚜렷한 변화가 없습니다. 현재 동반 변화가 단기 자금시장까지 이어진 근거는 약합니다.",
              supports_up=("broad",), supports_down=("hy",), supports_flat=("hy",)),
    ],
...
VOL_CALM_CREDIT_PERSIST = Combo(
    ...
    [
        Check("BBBOAS", "투자등급 경계 기업의 추가금리",
              "투자등급 경계 기업까지 추가금리가 확대됩니다. 회사채 변화가 더 넓게 오래 남는다는 설명을 지지합니다.",
              "투자등급 경계 기업의 추가금리는 줄어듭니다. 저신용 기업 중심 지속 설명과 더 잘 맞습니다.",
              "투자등급 경계 기업에는 뚜렷한 변화가 없습니다. 확산 범위는 제한적일 수 있습니다.",
              supports_up=("persist",), supports_down=("hy",), supports_flat=("hy",)),
        Check("AOAS", "A등급 기업의 추가금리",
              "A등급 기업의 추가금리도 확대됩니다. 신용 변화가 더 넓게 지속된다는 설명을 지지합니다.",
              "A등급 기업의 추가금리는 축소됩니다. 하이일드 중심 지속 설명과 더 잘 맞습니다.",
              "A등급 기업의 추가금리는 보합입니다. 투자등급 확산은 뚜렷하지 않습니다.",
              supports_up=("persist",), supports_down=("hy",), supports_flat=("hy",)),
        Check("CPSPREAD", "기업 신용도에 따른 단기자금 금리 차이",
              "단기자금 금리 차이도 벌어집니다. 주식시장 진정 뒤에도 자금조달 부담 차이가 남는 설명을 더 확인합니다.",
              "단기자금 금리 차이는 줄어듭니다. 부담 지속이 회사채 쪽에 더 집중된 설명과 맞습니다.",
              "단기자금 금리 차이에 뚜렷한 변화가 없습니다. 단기 자금시장까지 지속되는 근거는 약합니다.",
              supports_up=("persist",), supports_down=("hy",), supports_flat=("hy",)),
    ],
...
CYCLE_RENORM_CREDIT_WIDE = Combo(
    ...
    [
        Check("AOAS", "A등급 기업의 추가금리",
              "A등급 기업의 추가금리도 확대됩니다. 신용 변화의 범위가 넓다는 설명을 지지합니다.",
              "A등급 기업의 추가금리는 축소됩니다. 광범위한 신용 변화 설명은 약합니다.",
              "A등급 기업의 추가금리는 보합입니다. 하이일드 중심 변화일 수 있습니다.",
...
CYCLE_RENORM_CREDIT_QUIET = Combo(
    ...
    [
        Check("AOAS", "A등급 기업의 추가금리",
              "A등급 기업의 추가금리가 확대됩니다. 신용시장 변화도 함께 나타나는지 다시 확인합니다.",
              "A등급 기업의 추가금리는 축소됩니다. 현재 신용시장 변화가 넓다는 설명은 약합니다.",
              "A등급 기업의 추가금리는 보합입니다. 수익률곡선 경로와 현재 신용가격은 서로 다른 신호입니다.",
...
LONG_INV_2Y_DOWN = Combo(
    ...
    [
        Check("AOAS", "A등급 기업의 추가금리",
              "A등급 기업의 추가금리도 확대됩니다. 경기둔화·금융여건 우려 설명을 더 지지합니다.",
              "A등급 기업의 추가금리는 축소됩니다. 광범위한 신용 스트레스 설명은 약합니다.",
              "A등급 기업의 추가금리는 보합입니다. 현재 신용가격만으로 두 설명을 구분하기 어렵습니다.",
              supports_up=("slow",), weakens_down=("slow",)),
    ],
