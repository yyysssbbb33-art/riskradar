...
def _plan_dgs30(direction: str, state: str) -> GuidancePlan:
    intro = (
        ...
        "30년 금리 변화의 직접 구성은 첫 화면의 동일 만기 패널을 우선하고, 여기서는 10년 구간 참고 지표와 2년 금리를 별도 맥락으로 봅니다."
    )
    return GuidancePlan(intro, (
        _check(
            "DFII10",
            "10년 실질금리가 같은 방향인지 교차 만기 맥락으로 참고합니다. 30년 명목금리의 직접 구성요소는 아닙니다.",
            "10년 실질금리는 오르는 쪽입니다. 30년 동일 만기 구성과 별개로 10년 구간의 실질금리 부담도 커지는지 참고합니다.",
            "10년 실질금리는 내리는 쪽입니다. 30년 금리와 엇갈려도 직접 원인으로 단정하지 않습니다.",
            "10년 실질금리에 뚜렷한 움직임이 없어 교차 만기 참고 신호는 약합니다.",
        ),
        _check(
            "BREAKEVEN",
            "10년 명목−실질 금리차를 교차 만기 참고로 봅니다. 순수한 기대인플레이션이나 30년 구성요소로 보지 않습니다.",
            "10년 명목−실질 금리차가 커지는 방향입니다. 30년 구성은 같은 만기의 전용 패널을 우선합니다.",
            "10년 명목−실질 금리차가 줄어드는 방향입니다. 다른 만기의 금리 움직임을 직접 설명한다고 단정하지 않습니다.",
            "10년 명목−실질 금리차에 뚜렷한 움직임이 없습니다.",
        ),
        _check(
            "TERMPREM",
            "10년 Term Premium은 30년 동일 만기 산술 구성에 더하지 않는 별도 맥락입니다.",
            "10년 장기채 추가 보상이 커지는 방향입니다. 30년 금리와 나란히 참고하되 직접 구성요소나 원인으로 단정하지 않습니다.",
            "10년 장기채 추가 보상이 줄어드는 방향입니다. 30년 금리와의 방향 차이를 별도 맥락으로 남깁니다.",
            "10년 Term Premium에 뚜렷한 움직임이 없습니다.",
        ),
        _check(
            "DGS2",
            "같은 변화창에서 2년 금리와 30년 금리가 어떻게 움직였는지 봅니다. 곡선 분류는 첫 화면 전용 패널을 우선합니다.",
            "2년 금리도 오르는 방향입니다. 30년 금리와 어느 쪽이 더 크게 움직였는지는 같은 약 1개월 창에서 봅니다.",
...
def _plan_dgs2(direction: str, state: str) -> GuidancePlan:
    ...
    return GuidancePlan(intro, (
        ...
        _check(
            "BREAKEVEN",
            "10년 명목−실질 금리차가 가까운 금리 움직임과 같은 방향인지 교차 만기 맥락으로 참고합니다.",
            "10년 명목−실질 금리차가 커지는 방향입니다. 2년 금리의 직접 원인으로 단정하지 않습니다.",
            "10년 명목−실질 금리차가 줄어드는 방향입니다. 2년 금리와 엇갈려도 그 차이를 그대로 남깁니다.",
            "10년 명목−실질 금리차에 뚜렷한 움직임이 없습니다.",
        ),
    ))
...
def _plan_real(direction: str, state: str) -> GuidancePlan:
    intro = (
        ...
        "이 지표는 10년 구간의 교차 만기 참고입니다. 30년 금리 변화의 직접 구성은 첫 화면의 30년 동일 만기 패널을 우선합니다."
    )
    return GuidancePlan(intro, (
        _check(
            "BREAKEVEN",
            "같은 10년 구간의 명목−실질 금리차가 어느 방향인지 봅니다.",
            "10년 명목−실질 금리차도 커지는 방향입니다. 같은 10년 구간에서 두 움직임이 함께 나타나는지 참고합니다.",
            "10년 명목−실질 금리차는 줄어드는 방향입니다. 같은 10년 구간 안에서도 움직임이 엇갈립니다.",
            "10년 명목−실질 금리차에 뚜렷한 움직임이 없습니다.",
        ),
        _check(
            "TERMPREM",
            "10년 Term Premium은 별도 장기채 보상 맥락으로 참고합니다.",
        ...
        _check(
            "DGS30",
            "30년 금리와 방향을 비교하되 서로 다른 만기의 교차 참고로만 봅니다.",
            "30년 금리도 오르는 방향입니다. 두 만기가 같이 움직이지만 30년의 직접 구성은 동일 만기 패널에서 확인합니다.",
